...
['Blue', 'Green', 'Red', 'Yellow'].forEach(color => {
	test(`Flat-Remix-GTK-${color}`, t => {
		...
		t.is(variants.day, `Flat-Remix-GTK-${color}`);
		t.is(variants.night, `Flat-Remix-GTK-${color}-Dark`);
	});
	...
	test(`Flat-Remix-GTK-${color}-Darkest-Solid-NoBorder`, t => {
		...
		t.is(variants.day, `Flat-Remix-GTK-${color}-Solid`);
		t.is(variants.night, `Flat-Remix-GTK-${color}-Darkest-Solid-NoBorder`);
	});
